...
let step = 1; // Step 1: Verify, Step 2: Reset Password
let verifiedEmail = '';
...
function sendVerifyRequest(email, phone) {
    ...
    fetch('/Saloon%20Service%20Management/Management/Customer/MVC/php/forgot-password.php', {
        method: 'POST',
        body: formData
    })
    ...
    .then(data => {
        if (data.success === true) {
            ...
            // Disable email and phone inputs
